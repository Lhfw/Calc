...
class Calculator:
    def __init__(self):
        ...
        #for const place of operations labels
        self.operations_1 =  {"/": "\u00F7" }
        self.operations_2 =  {"*": "\u00D7" }
        self.operations_3 =  {"-": "-" }
        self.operations_4 =  {"+": "+" }
        ...
        #create field for operations and numbers
        for x in range(1, 5):
    ...
    def create_operations_buttons(self):
        self.create_operator_buttons_1()
        self.create_operator_buttons_2()
        self.create_operator_buttons_3()
        self.create_operator_buttons_4()
    ...
    def create_digit_buttons(self):
        for digit,grid_value in self.digits.items():
            button = tk.Button(self.buttons_frame,
                               ...
                               borderwidth = 0,
                               activeforeground = DIGITS_COLOR,
                               command = lambda x =
                                                digit: self.add_to_expression(x))
    ...
    def create_operator_buttons_1(self):

        for operator, symbol in self.operations_1.items():
            button = tk.Button(self.buttons_frame,
                               text=symbol,
                               bg=OFF_WHITE,
                               fg=LABEL_COLOR,
                               ...
                               borderwidth=0,
                               command=lambda x=
                                              operator: self.append_operator(x))
            button.grid(row=0, column=4, sticky=tk.NSEW)

    def create_operator_buttons_2(self):

        for operator, symbol in self.operations_2.items():
            button = tk.Button(self.buttons_frame,
                               text=symbol,
                               bg=OFF_WHITE,
                               fg=LABEL_COLOR,
    ...
    def create_operator_buttons_3(self):

        for operator, symbol in self.operations_3.items():
            button = tk.Button(self.buttons_frame,
                               text=symbol,
                               bg=OFF_WHITE,
                               fg=LABEL_COLOR,
    ...
    def create_operator_buttons_4(self):

        for operator, symbol in self.operations_4.items():
            button = tk.Button(self.buttons_frame,
                               text=symbol,
                               bg=OFF_WHITE,
                               fg=LABEL_COLOR,
